...
{#if step && step.href}
    <a
        ...
        rounded-lg border border-solid border-violet-700 text-center cursor-pointer group
    ...
    >
        ...
        <div class="flex-1 flex justify-between gap-4 items-center">
            ...
            after:w-full after:h-full after:bg-white after:duration-200 hover:after:translate-x-full 
