...
>
    ...
    <div class="flex flex-col gap-4 items-center justify-center">
        <p><b class="pr-2">Email</b> lokhandeharshal716@gmail.com</p>
        <p>
            <b class="pr-2">GitHub</b>
            <a class="text-violet-400" target="_blank" href="https://github.com/Harshal-dl"
                >harshal-lokhande<sup
        ...
        <p>
            ...
            <a class="text-violet-400" target="_blank" href="https://www.linkedin.com/in/harshal-dl76/"
                >harshal-lokhande<sup
                    ><span class="text-xs scale-75 pl-0.5"
                        ><i
                            class="fa-solid fa-arrow-up-right-from-square text-xs scale-[75%"
