...
<header 
    ...
    <h1 class="font-medium">
        <b class="font-bold poppins">Harshal</b> <span class=" ">Lokhande</span>
    </h1>
    <div class="sm:flex ml-auto pr-4 items-centre gap-4 hidden">
    ...
    <a href="https://www.linkedin.com/in/harshal-dl76/" 
        target="_blank"
